...
// 5. Reports exist
for (const f of ['redirect-sync-report.md', 'vercel-redirect-sync-report.md', 'dns-cutover-checklist.md', 'post-cutover-monitoring.md', 'redirect-backlog.md', 'real-image-shot-list.md']) {
